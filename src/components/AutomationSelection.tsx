...
export const AutomationSelection: React.FC<AutomationSelectionProps> = ({
  ...
  const { formData, updateFormData, validateCurrentStep, setStep } = useFormStore();
  ...
  const handleSaveAndContinue = () => {
    ...
    if (validateCurrentStep()) {
      setStep(4); // Move to workflow builder step
    }
  };
          ...
          return (
            ...
            >
              <CardHeader 
                ...
                onClick={() => toggleSection(`automation_${automation.id}`)}
              >
